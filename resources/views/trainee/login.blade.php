...
<head>
    ...
    <style>
        ...
        .login-bg {
            background: linear-gradient(135deg, #000, #333, #666, #999, #fff);
...
<body class="login-bg min-h-screen flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-md glass-card rounded-2xl overflow-hidden">
        <div class="p-8">
            <div class="text-center mb-8 up-down-motion">
                ...
                <p class="text-gray-600 mt-2">Welcome Back! Please Login</p>
            </div>

            <form method="POST" action="{{ route('trainee.login') }}" class="space-y-6">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('password.request') }}" class="text-sm text-orange-600 hover:text-orange-800">
                        Forgot Password?
                    </a>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-orange-700">
                   Orange Coding Academy
                    <!-- <a href="{{ route('register') }}" class="text-orange-600 hover:text-orange-800 font-semibold">
                        Sign Up
                    </a> -->
                </p>
            </div>
