<nav x-data="{ open: false }" class="navbar navbar-expand-lg border-b border-gray-100">
    <div class="container-fluid">
        <!-- Orange Logo -->
        <div class="navbar-brand">
            <a href="{{ route('dashboard') }}" class="stretched-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.46 283.46" width="50" height="50">
                    <defs>
                        <style>
                            #a {
                                fill: #ff7900;
        ...
        <button class="navbar-toggler" type="button" @click="open = !open"
                aria-controls="navbarContent" aria-expanded="open" aria-label="Toggle navigation">
    ...
    <!-- Mobile User Info -->
    <div x-show="open" class="d-lg-none border-top border-gray-200 mt-3 p-3">
        <div class="px-4">
