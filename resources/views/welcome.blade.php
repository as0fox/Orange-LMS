...
<body class="bg-[#121212] text-white">
    ...
    <div id="mobileMenu" class="mobile-menu flex flex-col justify-center items-center md:hidden">
        ...
        <div class=" md:block hero-animation">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.46 283.46" class="mx-auto w-22 h-22 mb-4">
                    <defs>
                        <style>
                            #a { fill: #ff7900; }
                            #b, #c { fill: #fff; }
    ...
    <main class="pt-24 container mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center ">
        <div class="space-y-8 mt-16">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <a href="{{route('learn.show')}}"
                    class="bg-gradient-orange text-white px-4 py-2 rounded-lg text-center hover:scale-105 transition">
                    Start Your Journey
                </a>
                <a href="#"
        ...
        <div class="hidden md:block hero-animation">
